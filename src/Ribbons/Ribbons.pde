...
void setup(){
  ...
  ribbonManager = new RibbonManager(ribbonAmount, ribbonParticleAmount, randomness, "palette.jpg");    // field, rothko_01-02, absImp_01-03 picasso_01
...
void draw(){
  ...
  for(int i = 0; i < numblobs; i++) {
    ...
    ribbonManager.update(int(ab.cx),int(ab.cy));
